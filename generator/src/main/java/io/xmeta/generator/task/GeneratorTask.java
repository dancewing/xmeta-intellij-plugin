package io.xmeta.generator.task;

import io.xmeta.generator.util.FileUtils;
...
public class GeneratorTask extends Task.Modal {
    ...
    private final DialogWrapper windows;
    private final Generator generator;
    private final List<File> templates;
    private final List<RootModel> rootModels;

    public GeneratorTask(@NotNull Project project, DialogWrapper windows, Generator generator, List<File> templates,
                         List<RootModel> rootModels) {
